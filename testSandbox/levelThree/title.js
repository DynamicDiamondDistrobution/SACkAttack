...
var titleState = {
	create: function(){
		var nameLabel0 = game.add.text(212, 100, "SACk ATTACK!!", {
		font: '48px Tahoma', fill: '#670202'});
		var nameLabel1 = game.add.text(212, 200, "Use Arrow Keys to move: LEFT, RIGHT, and UP.", {
		font: '14px Tahoma', fill: '#ffffff'});
		var nameLabel2 = game.add.text(232, 300, "Click anywhere to start", {
		font: '14px Tahoma', fill: '#ffffff'});
